...
var Required = (function (_Criterion) {
    ...
    function Required() {
        ...
        _get(Object.getPrototypeOf(Required.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    _createClass(Required, [{
        ...
        value: function enforce(key, value, done) {
            ...
            if (value === '' || value === null || value === undefined) return done(new Error('The field \'' + key + '\' is required!'), key, value);
