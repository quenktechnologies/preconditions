...
const runTest = (conf: TestConf) => {
    ...
    for (let test of Array.isArray(conf.test) ? conf.test : [conf.test]) {
        ...
        if (test.ok) {
            ...
            assert(
                result.isRight(),
                test.msg || 'input satisfied precondition'
            ).true();
            assert(result.takeRight()).equate(
            ...
            assert(
                result.isLeft(),
                test.msg || 'bad input failed precondition'
            ).true();
...
describe('schema', () => {
    describe('fromSchema', () => {
        describe('object type', () => {
            ...
            it('should produce a precondition', () =>
                runTest({
                    schema,
                    test: [
                        {
            ...
            it('should cast properties when strict is false', () =>
                runTest({
            ...
            it('should not cast properties when strict is true', () =>
                runTest({
                    options: { strict: true },
                    schema: schema,
                    test: {
            ...
            it('should allow nullable optional properties', () =>
                runTest({
                    schema: {
                        type: 'object',
                        properties: {
            ...
            it('should allow nested partial objects', () =>
                runTest({
                    options: { partial: true },
                    schema: {
                        type: 'object',
        ...
        describe('array type', () => {
            it('should produce a precondition for an array schema', () =>
                runTest({
                    schema: {
                        type: 'array',
                        minLength: 2,
            ...
            it('should produce a precondition for an array schema with object items', () =>
                runTest({
                    schema: {
                        type: 'array',
                        items: {
            ...
            it('should produce a precondition for an array schema with array items', () =>
                runTest({
                    schema: {
                        type: 'array',
                        items: {
            ...
            it('should cast array items when strict is false', () =>
                runTest({
                    schema: {
                        type: 'array',
                        items: {
            ...
            it('should not cast array items when strict is true', () =>
                runTest({
                    options: { strict: true },
                    schema: {
                        type: 'array',
            ...
            it('should be nullable when optional is set', () =>
                runTest({
                    schema: {
                        type: 'array',
                        minLength: 100,
                    ...
                    test: { ok: true, input: undefined }
                }));

            it('should not be nullable if the items schema is optional', () =>
                runTest({
                    schema: {
                        type: 'array',
                        minLength: 100,
                    ...
                    test: { ok: false, input: undefined, output: 'isArray' }
                }));
        });

        describe('string type', () => {
            it('should produce a precondition for a string schema', () =>
                runTest({
                    schema: {
                        type: 'string',
                        minLength: 2,
            ...
            it('should produce a precondition for a string schema with a regex', () =>
                runTest({
                    schema: {
                        type: 'string',
                        pattern: /[a-z]+/
            ...
            it('should produce a precondition for a string schema with enum values', () =>
                runTest({
                    schema: {
                        type: 'string',
                        enum: ['foo', 'bar', 'baz'],
            ...
            it('should cast to string when strict is false', () =>
                runTest({
                    options: { strict: false },
                    schema: {
                        type: 'string'
                    },
                    test: [{ ok: true, input: ['str'], output: 'str' }]
                }));

            it('should not cast to string when strict is true', () =>
                runTest({
                    options: { strict: true },
                    schema: {
                        type: 'string'
            ...
            it('should be nullable if optional is set', () =>
                runTest({
                    schema: {
                        type: 'string',
                        optional: true
        ...
        describe('number type', () => {
            it('should produce a precondition for a number schema', () =>
                runTest({
                    schema: {
                        type: 'number',
                        min: 0,
            ...
            it('should produce a precondition for a number schema with enum values', () =>
                runTest({
                    schema: {
                        type: 'number',
                        enum: [1, 2, 3],
            ...
            it('should cast to number when strict is false', () =>
                runTest({
                    options: { strict: false },
                    schema: {
                        type: 'number'
                    },
                    test: [{ ok: true, input: '12', output: 12 }]
                }));

            it('should not cast to number when strict is true', () =>
                runTest({
                    options: { strict: true },
                    schema: {
                        type: 'number'
            ...
            it('should detect bad number casts', () => {
                assert(
                    fromSchema({ strict: false }, { type: 'number' })
                        .takeRight()({})
                        .takeLeft()
                        .explain()
                ).equal('NaN');
        ...
        describe('boolean type', () => {
            it('should produce a precondition for a boolean schema', () =>
                runTest({
                    schema: { type: 'boolean' },
                    test: [
                        {
                            ok: true,
                            input: true,
                            msg: 'true input satisfied precondition'
                        },
                        {
                            ok: true,
                            input: false,
                            msg: 'input satisfied precondition'
                        },
                        {
                            ok: true,
                            input: 'yes',
                            output: true,
                            msg: 'non-boolean input is cast'
                        }
                    ]
                }));

            it('should cast to boolean when strict is false', () =>
                runTest({
                    schema: {
                        type: 'boolean'
                    },
            ...
            it('should not cast to boolean when strict is true', () =>
                runTest({
                    options: { strict: true },
                    schema: {
                        type: 'boolean'
        ...
        describe('refs', () => {
            it('should not produce a precondition if a ref is missing', () => {
                ...
                assert(
                    eprec.takeLeft().message.includes('"flip" not found')
                ).true();
                ...
                assert(eprec.isLeft()).true();
                assert(
                    eprec.takeLeft().message.includes('"flipx" not found')
                ).true();
            });
        });
    });
