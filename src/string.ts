...
export const uppercase: Precondition<string, string> =
    (value: string) => succeed<string, string>(value.toUpperCase());
...
export const lowercase: Precondition<string, string> =
    (value: string) => succeed<string, string>(value.toLowerCase());
...
export const trim: Precondition<string, string> =
    (value: string) => succeed<string, string>(value.trim());

/**
 * split a string into an array.
 */
export const split = (token: string): Precondition<string, string[]> =>
    (value: string) => succeed<string, string[]>(value.split(token));
