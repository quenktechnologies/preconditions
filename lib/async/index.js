...
exports.or = function (left, right) { return function (value) {
    return left(value).then(function (e) {
        return (either_1.either(function_1.cons(right(value)))(result_1.success)(e));
    });
}; };
/**
 * and (async version).
...
exports.and = function (l, r) { return function (value) {
    return l(value).then(function (e) {
        return e.map(function (b) { return r(b); })
            .orRight(function (f) { return result_1.failure(f.message, value, f.context); })
            .takeRight();
    });
}; };
/**
...
exports.caseOf = function (t, p) { return function (value) {
    return kindof_1.kindOf(value, t) ? p(value) : result_1.failure('caseOf', value, { type: t });
}; };
/**
 * match (async version).
 */
    ...
    return function (value) { return list.reduce(function (pe, f) {
        return pe
            ...
            Promise
                ...
                f(value) :
                result_1.failure(r.message, value, r.context); }); });
    }, p(value)); };
};
/**
