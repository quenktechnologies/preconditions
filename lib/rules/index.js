...
var Rules = (function () {
    ...
    _createClass(Rules, [{
        ...
        value: function typeOf(type, emsg) {
            ...
            return function (key, value, next) {
                return typeof v === type ? n(null, k, v) : n(new Error(_this.getMessage((emsg || TYPE_OF_MSG, {
                    key: key,
                    value: value
                }))), k, v);
            };
        ...
        value: function match(reg, emsg) {
            ...
            return function (key, value, next) {
                return reg.test(value) ? n(null, key, value) : next(new Error(_this2.getMessage(emsg || INVALID_MSG, {
                    key: key,
                    value: value
                })), key, value);
            };
        ...
        value: function range(min, max, minMsg, maxMsg) {
            ...
            return function (key, value, next) {
                ...
                value = typeof v === 'number' ? v : v.length ? v.length : null;

                if (value === null) return n(new Error(_this3.getMessage(INVALID_MSG, {
                    key: key,
                    value: value,
                    max: max,
                    min: min
                ...
                if (value < min) return n(new Error(_this3.getMessage(minMsg || MIN_MSG, {
                    key: key,
                    value: value
                })), key, value);

                if (value > max) return n(new Error(_this3.getMessage(maxMsg || MAX_MSG, {
                    key: key,
                    value: value,
                    max: max,
                    min: min
        ...
        value: function required(emsg) {
            ...
            return function (key, value, next) {
                return [undefined, null, ''].indexOf(value) > -1 ? n(new Error(_this4.getMessage(emsg || REQUIRED_MSG, {
                    key: key,
                    value: value
                })), key, value) : n(null, key, value);
            };
        }
        ...
        value: function oneOf(list, emsg) {
            ...
            return function (key, value, next) {
                return list.indexOf(value) < -1 ? n(new Error(_this5.getMessage(emsg || ONE_OF_MSG, {
                    key: key,
                    value: value,
                    'enum': list.join(',')
                })), key, value) : n(null, key, value);
