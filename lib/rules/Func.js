...
var Func = (function (_Criterion) {
    _inherits(Func, _Criterion);

    function Func(f, next) {
        _classCallCheck(this, Func);

        _get(Object.getPrototypeOf(Func.prototype), 'constructor', this).call(this, next);
        this._f = f;
    }
    ...
    _createClass(Func, [{
        ...
        value: function apply(key, value, done) {
            ...
            this._f(key, value, function (err, key, value) {

                if (err !== null) return done(err, key, value);

                return _this.next(key, value, done);
            });
        }
    }]);
