 ...
 */
exports.set = function (b) { return function (_) { return failure_1.success(b); }; };
...
exports.equals = function (target) {
    return function (value) { return (target === value) ?
        failure_1.success(target) :
        failure_1.failure('equals', value, { target: target }); };
};
/**
...
exports.notNull = function (value) {
    return ((value == null) || ((typeof value === 'string') && (value === ''))) ?
        failure_1.failure('notNull', value) :
...
exports.exists = function (list) { return function (value) {
    return (list.indexOf(value) < 0) ?
        failure_1.failure('exists', value, { value: value, list: list }) :
        failure_1.success(value);
}; };
/**
...
exports.caseOf = function (t, p) { return function (value) {
    return _kindOf(t, value) ? p(value) : failure_1.failure('caseOf', value, { type: t });
}; };
...
exports.log = function (value) {
    return console.log(value) || failure_1.success(value);
};
