...
exports.every = function (p) {
    ...
    return function (value) {
        return either_1.either(function (f) { return either_1.left(f); })(function (v) { return list.reduce(function (e, f) { return e.chain(f); }, either_1.right(v)); })(p(value));
    };
};
/**
 ...
 */
exports.log = function (value) { return console.error(value) || result_1.success(value); };
