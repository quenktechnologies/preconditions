    ...
    Map.prototype.apply = function (value) {
        ...
        if (typeof value !== 'object') {
            ...
            var reports = afpl.util.reduce(conditions, function (r, p, k) {
                return p.apply(value[k]).cata(exports.whenLeft(k, r), exports.whenRight(k, r));
            }, init);
...
exports.number = function () {
    return exports.func(function (n) { return (typeof n === 'number') ? exports.valid(n) : exports.fail('number', n); });
};
/**
 * string tests if the value is a string.
 */
exports.string = function () {
    return exports.func(function (s) { return (typeof s === 'string') ?
        exports.valid(s) :
...
exports.list = function () {
    return exports.func(function (a) { return (Array.isArray(a)) ?
        exports.valid(a) :
        exports.fail('list', a); });
};
/**
...
exports.optional = function (t) {
    return exports.func(function (value) { return (value == null) ? exports.valid(null) : t.apply(value); });
};
/**
