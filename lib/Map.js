 ...
 */
exports.decide = function (condition, left, right) {
    return exports.func(function (value) { return condition ? left.apply(value) : right.apply(value); });
};
/**
 ...
 * @returns {Predicate}
 */
exports.nullable = function () { return exports.func(function (value) { return exports.valid(value); }); };
/**
