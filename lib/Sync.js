...
exports.partial = function (conditions) {
    return function (value) {
        ...
        if (typeof value !== 'object') {
            ...
            var reports = afpl.util.reduce(value, function (r, a, k) {
...
exports.or = function (left, right) {
    return function (value) {
        return left(value)
            .cata(function () { return right(value); }, function (b) { return exports.valid(b); });
    };
};
/**
 * and
 ...
 */
exports.populated = function (value) { return Object.keys(value).length === 0 ?
    exports.fail('populated', value) : exports.valid(value); };
/**
 ...
 */
exports.equals = function (target) { return function (value) { return isB(value, target) ?
    exports.valid(target) : exports.fail('equals', value, { target: target }); }; };
/**
...
exports.number = function (n) {
    return (typeof n === 'number') ? exports.valid(n) :
...
exports.cast = function (f) { return function (a) { return exports.valid(f(a)); }; };
