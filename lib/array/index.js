...
exports.filter = function (p) { return function (value) {
    return result_1.success(value.map(function (a) { return (either_1.either(function () { return null; })(function_1.id)(p(a))); })
...
exports.map = function (p) {
    return function (value) { return failure_1.review(value, value.reduce(function (reports, a, k) {
