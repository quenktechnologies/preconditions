 ...
 * maxItems test.
 */
exports.maxItems = function (target) { return function (value) {
    return (value.length > target) ?
        result_1.failure('maxItems', value, { target: target, value: value }) :
        result_1.success(value);
}; };
/**
 * minItems test.
 */
exports.minItems = function (target) { return function (value) {
    return (value.length < target) ?
        result_1.failure('minItems', value, { target: target, value: value }) :
        result_1.success(value);
}; };
/**
...
exports.map = function (p) { return function (value) {
    return result_2.review(value, value.reduce(function (reports, a, k) {
