...
exports.range = function (min, max) { return function (value) {
    return (value.length < min) ?
        ...
        (value.length > max) ?
            failure_1.failure('range.max', value) :
...
exports.filter = function (p) { return function (value) {
    return failure_1.success(value
        .map(p)
...
exports.map = function (p) { return function (value) {
    return failure_2.review(value, value.reduce(function (reports, a, k) {
